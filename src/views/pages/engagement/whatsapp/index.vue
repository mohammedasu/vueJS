              ...
              <div class="col-md-6">
                <div class="all-tabs">
                  ...
                  >
                    ...
                    <router-link :to="{ name: 'add-whatsapp' }" class="opt"
                      >Add Whatsapp</router-link
                    >
                  </div>
                </div>
              </div>
            ...
            <div class="table-responsive mb-0">
              ...
              >
                <template v-slot:cell(is_processed)="row">
                  <div v-if="row.item.is_processed == 1">Yes</div>
                  <div v-else>No</div>
                </template>
                <template v-can="'edit-whatsapp'" v-slot:cell(edit)="row">
                  <router-link
                    :to="{
                      name: 'edit-whatsapp',
                ...
                <template v-slot:cell(delete)="row" v-can="'delete-whatsapp'">
                  <div
                    @click.prevent="deleteWhatsapp(row.item.id)"
                  >
...
export default {
  data() {
    return {
      title: "Whatsapp Engagement Module",
      items: [
        {
          text: "Home",
          href: "/",
