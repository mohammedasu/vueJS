<template>
  <Layout>
    ...
    <div class="row" id="notification-master">
      <div class="col-12">
        <div class="card">
          <div class="card-body">
              ...
              <div class="col-md-6">
                <div class="all-tabs">
                  ...
                  <div
                    ...
                    v-if="can('add-master-notification')"
                  >
                    <svg
                    ...
                    <router-link
                      :to="{ name: 'add-master-notification' }"
                      class="opt"
            ...
            <div class="table-responsive mb-0">
              ...
              >
                <template
                  v-can="'update-master-notification-status'"
                  v-slot:cell(is_active)="row"
                >
                  <b-form-checkbox
                    switch
                    class="mb-1"
                    @change="updateStatus(row.item.notification_master_ref_no)"
                    :checked="row.item.is_active == 1 ? true : false"
                  >
                  </b-form-checkbox>
                </template>
                <template
                  v-can="'edit-master-notification'"
                    ...
                    :to="{
                      ...
                      params: {
                        notification_master_ref_no:
                          row.item.notification_master_ref_no,
                      },
                    }"
                  >
                ...
                <template v-slot:cell(delete)="row">
                  <div
                    v-if="
                      activeTab == 'trash' && can('restore-master-notification')
                    "
                    @click.prevent="
                      restoreNotificationMaster(
                        row.item.notification_master_ref_no
                      )
                    "
                  >
                  ...
                  <div
                    v-else-if="
                      activeTab != 'trash' && can('delete-master-notification')
                    "
                    @click.prevent="
