        ...
        <div class="card">
          <div class="card-body">
              ...
              <div class="col-md-6">
                <div class="all-tabs">
                  ...
                  <div
                    ...
                    v-if="can('add-email-notification')"
                  >
                    <svg
                    ...
                    <router-link
                      ...
                      >Add Email Notification</router-link
                    >
                  </div>
                </div>
              </div>
            ...
            <div class="table-responsive mb-0">
              ...
              >
                <template
                  v-can="'update-email-notification-status'"
                ...
                <template v-slot:cell(delete)="row">
                  <div
                    v-if="
                      activeTab == 'trash' && can('restore-email-notification')
                    "
                    type="submit"
                    @click.prevent="restoreEmail(row.item.template_ref_no)"
                  >
                    <i class="mdi mdi-restore restore-i"></i>
                  </div>
                  <div
                    type="submit"
                    @click.prevent="deleteEmail(row.item.template_ref_no)"
                    v-else-if="
                      activeTab != 'trash' && can('delete-email-notification')
                    "
                  >
