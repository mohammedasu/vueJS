        ...
        <div class="card">
          <div class="card-body">
              ...
              <div class="col-md-6">
                <div class="all-tabs">
                  ...
                  <div
                    ...
                    v-if="can('add-push-notification')"
                  >
                    <svg
                    ...
                    <router-link
                      :to="{ name: 'add-push-notification' }"
                      class="podcast-options"
                      >Add Push Notification</router-link
                    >
                  </div>
                </div>
              </div>
            ...
            <div class="table-responsive mb-0">
              ...
              >
                <template
                  v-can="'update-push-notification-status'"
                ...
                <template v-slot:cell(delete)="row">
                  <div
                    v-if="
                      activeTab == 'trash' && can('restore-push-notification')
                    "
                    type="submit"
                    @click.prevent="restorePush(row.item.template_ref_no)"
                  >
                    <i class="mdi mdi-restore restore-i"></i>
                  </div>
                  <div
                    type="submit"
                    @click.prevent="deletePush(row.item.template_ref_no)"
                    v-else-if="
                      activeTab != 'trash' && can('delete-push-notification')
                    "
                  >
