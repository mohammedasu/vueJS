        ...
        <div class="card">
          <div class="card-body">
              ...
              <div class="col-md-6">
                <div class="all-tabs">
                  ...
                  >
                    ...
                    <router-link
                      :to="{ name: 'add-sms-notification' }"
                      class="podcast-options"
                      >Add SMS Notification</router-link
                    >
                  </div>
                </div>
              </div>
            ...
            <div class="table-responsive mb-0">
              ...
              >
                <template
                  v-can="'update-sms-notification-status'"
                ...
                <template v-slot:cell(delete)="row">
                  <div
                    v-if="
                      activeTab == 'trash' && can('restore-sms-notification')
                    "
                    type="submit"
                    @click.prevent="restoreSMS(row.item.template_ref_no)"
                  >
                    <i class="mdi mdi-restore restore-i"></i>
                  </div>
                  <div
                    type="submit"
                    @click.prevent="deleteSMS(row.item.template_ref_no)"
                    v-else-if="
                      activeTab != 'trash' && can('delete-sms-notification')
                    "
                  >
