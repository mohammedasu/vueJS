          ...
          <div class="card-body">
            ...
            <div class="table-responsive mb-0">
              <b-table
                ...
                :key="key"
              >
                <template v-slot:cell(website_banner_image)="row">
                  <img :src="row.item.website_banner_image" class="partner_banner" alt="">
                </template>
                <template v-slot:cell(is_visible_in_home)="row">
                  <template v-if="row.item.is_visible_in_home">
                ...
                <template v-can="'edit-partner'" v-slot:cell(edit)="row">
                  <router-link
                    :to="{ name: 'edit-partner', params: { id: row.item.id } }"
                  >
                ...
                <template
                  ...
                  v-can="'delete-partner'"
                >
                  <div
                    v-if="activeTab != 'trash'"
                    @click.prevent="deletePartner(row.item.id)"
                  >
                ...
                <template
                  ...
                  v-can="'restore-partner'"
                >
                  <div
                    v-if="activeTab == 'trash'"
                    @click.prevent="restorePartner(row.item.id)"
                  >
