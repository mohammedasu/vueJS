          ...
          <div class="card-body">
                ...
                <div class="all-tabs">
                  ...
                  <template  v-if="can('add-podcast')">
                    ...
                    >
                      ...
                      <router-link :to="{ name: 'add-podcast' }" class="opt"
                        >Add Podcast</router-link
                      >
                    </div>
                  </template>
                </div>
            ...
            <div class="table-responsive mb-0">
              ...
              >
                ...
                <template v-can="'edit-podcast'" v-slot:cell(edit)="row">
                  <router-link
                    :to="{ name: 'edit-podcast', params: { id: row.item.id } }"
                  >
                ...
                <template
                  ...
                  v-can="'delete-podcast'"
                >
                  <div
                    v-if="activeTab != 'trash'"
                    @click.prevent="deletePodcast(row.item.id)"
                  >
                ...
                <template
                  ...
                  v-can="'restore-podcast'"
                >
                  <div
                    v-if="activeTab == 'trash'"
                    @click.prevent="restorePodcast(row.item.id)"
                  >
