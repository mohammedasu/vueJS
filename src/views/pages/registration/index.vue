          ...
          <div class="card-body">
              ...
              <div class="col-md-6">
                <div class="all-tabs">
                  <div class="d-flex align-items-center">
                    ...
                    <router-link
                      :to="{ name: 'add-registration' }"
                      class="podcast-options"
                      >Add Registration</router-link
                    >
                  </div>
                </div>
              </div>
            ...
            <div class="table-responsive mb-0">
              ...
              >
                ...
                <template v-can="'edit-registration'" v-slot:cell(edit)="row">
                  <router-link
                    :to="{
                ...
                <template
                  v-can="'delete-registration'"
                  v-slot:cell(delete)="row"
                >
                  <div @click.prevent="deleteRegistration(row.item.id)">
