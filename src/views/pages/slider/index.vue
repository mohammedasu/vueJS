              ...
              <div class="col-md-6">
                <div class="all-tabs">
                  ...
                  >
                    ...
                    <router-link :to="{ name: 'add-slider' }" class="opt"
            ...
            <div class="table-responsive mb-0">
              ...
              >
                <template v-slot:cell(image)="row">
                  <img :src="row.item.image" class="thumbnail_img" alt="">
                </template>
                <template
                  v-can="'update-slider-status'"
                ...
                <template v-can="'edit-slider'" v-slot:cell(edit)="row">
                  <router-link
                    :to="{ name: 'edit-slider', params: { id: row.item.id } }"
                  >
                ...
                <template v-slot:cell(delete)="row">
                  <div
                    v-if="activeTab == 'trash' && can('restore-slider')"
                    @click.prevent="restoreSlider(row.item.id)"
                  >
                    <i class="mdi mdi-restore restore-i"></i>
                  </div>
                  <div
                    v-else-if="activeTab != 'trash' && can('delete-slider')"
                    @click.prevent="deleteSlider(row.item.id)"
                  >
